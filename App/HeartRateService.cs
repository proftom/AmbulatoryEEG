...
namespace BluetoothGattHeartRate
{
    ...
    public class HeartRateService
    {
        ...
        private Windows.Storage.StorageFile sf;
        ...
        private async Task<Windows.Storage.StorageFile> testc()
        {
            
            var _Folder = Windows.Storage.ApplicationData.Current.LocalFolder;
            var _Option = Windows.Storage.CreationCollisionOption.ReplaceExisting;

            return await _Folder.CreateFileAsync("test", _Option);
