...
#define HANDLE_EEG_SERVICE              (0x0009)
#define HANDLE_EEG_SERVICE_END          (0x0010)
#define ATTR_LEN_EEG_SERVICE            (2)
...
#define ATTR_LEN_DEVICE_INFO_SERIAL_NUMBER (18)
...
#define ATTR_LEN_DEVICE_INFO_FIRMWARE_REVISION (17)
#define HANDLE_DEVICE_INFO_SOFTWARE_REVISION (0x001d)
#define ATTR_LEN_DEVICE_INFO_SOFTWARE_REVISION (23)
#define HANDLE_DEVICE_INFO_MANUFACTURER_NAME (0x001f)
#define ATTR_LEN_DEVICE_INFO_MANUFACTURER_NAME (17)
