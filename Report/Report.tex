...
\item AT24C512C-SSHD 512K Serial EEPROM Flash for CSR's non-volatile storage
\end{itemize}
...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[width = 1.5\textwidth, angle = 90]{Schematic}
	\end{center}
	\caption{Schematic}
	\label{fig:schematic}
\end{figure}
