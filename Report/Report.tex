...
Another \ac{NS} product tested was the nRF51822. Information on the suppport packets per connection event was also not present in the datasheet\cite{nrf51822}. This device was found capable of receiving up to 6 packets per second, and this was verified by an engineer\cite{olem}

Unfortunately the chip came as part of a larger development kit and accurate power measurements were not attainable. 


\subsubsection{CC2541}
\ac{TI}'s CC2541 is part of the sensor tag package - a \ac{BLE} popular development kit.

Much like 

Similarly the CC2540 has the same characteristics
...
The first iteration of the board. Due to the process capabilities and materials used, the radio frequency traces were not impeadance matched, and the device range was limited to approximately 7 meters within a building or 15 meters \ac{LOS}.
...
The idea of minimising energy per bit is not the true picture, as \ac{BTC} and WiFi have higher energy per bit ratios. 
