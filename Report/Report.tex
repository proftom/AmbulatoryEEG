...
For initial throughput testing, an example health thermometer application was used. \ac{CSR} provided a \ac{USB} dongle which is capable 

From exploring the \ac{API}s and understanding the main features of the \ac{OSAL}, it was possible to increase the number of notification packets sent per connection interval from 1 to 8. Attempting to increase the  A comprehensive explanation of the code is provided in the later section \ref{Prototype}. 
